 ...
 * It uses a GLJPanel which works in JavaFX's SwingNode.
 * The visibility of this class is "package". To create a new
 * CefBrowser instance, please use CefBrowserFactory.
 */
class CefBrowserGLJPanel extends CefBrowser_N implements CefRenderHandler {
    ...
    public CefBrowserGLJPanel(CefClient client, String url, boolean transparent,
            CefRequestContext context, CefBrowserSettings settings) {
        this(client, url, transparent, context, null, null, settings);
    }

    private CefBrowserGLJPanel(CefClient client, String url, boolean transparent,
            CefRequestContext context, CefBrowserGLJPanel parent, Point inspectAt,
    ...
    protected CefBrowser_N createDevToolsBrowser(CefClient client, String url,
        ...
        return new CefBrowserGLJPanel(
                client, url, isTransparent_, context, (CefBrowserGLJPanel) this, inspectAt, null);
    }
    ...
    public void onPaint(CefBrowser browser, boolean popup, Rectangle[] dirtyRects,
        ...
        final GLContext context = panel_ != null ? panel_.getContext() : null;
    ...
    public CompletableFuture<BufferedImage> createScreenshot(boolean nativeResolution) {
        int width = (int) Math.ceil(panel_.getWidth() * scaleFactor_);
        int height = (int) Math.ceil(panel_.getHeight() * scaleFactor_);
        ...
        if (SwingUtilities.isEventDispatchThread()) {
            ...
            panel_.addGLEventListener(new GLEventListener() {
                ...
                public void display(GLAutoDrawable aDrawable) {
                    panel_.removeGLEventListener(this);
                    try {
